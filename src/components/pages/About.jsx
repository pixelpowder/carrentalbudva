...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p>Budva sits in the middle of the Montenegrin coast. From here, <a href={localePath('/blog/milocer-park-villa')}>Miločer Park and Sveti Stefan</a> are 10 minutes south, Bečići is 5 minutes round the headland, Petrovac is 20 minutes further. The Bay of Boka is 30 minutes. Tivat Airport is 25 minutes. The whole Budva Riviera — Jaz, Bečići, Rafailovići, Sveti Stefan, Petrovac — is accessible on a single tank.</p>
      <p>The Riviera is also the base for inland drives: the <a href={localePath('/blog/rezevici-monastery')}>Reževići Monastery</a> and the <a href={localePath('/blog/budva-to-lovcen-mausoleum')}>Lovćen serpentine</a> via Njeguši toward Cetinje.</p>
