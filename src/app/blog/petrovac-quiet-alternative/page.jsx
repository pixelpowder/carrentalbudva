...
export async function generateMetadata() {
  return {
    ...
    alternates: buildAlternates('blog/petrovac-quiet-alternative'),
    openGraph: { title: "Petrovac — The Quiet Alternative to Budva", description: "Why Petrovac works as day trip or base from Budva: the beach, Kastel Lastva fortress, restaurants, parking, and how long the drive takes.", type: 'website' },
  };
}

export default function PetrovacQuietAlternativeRoute() {
  const articleSchema = {
