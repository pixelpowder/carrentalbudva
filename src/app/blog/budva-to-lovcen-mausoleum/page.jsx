...
export async function generateMetadata() {
  return {
    ...
    alternates: buildAlternates('blog/budva-to-lovcen-mausoleum'),
    openGraph: { title: "Budva to Lovćen Mausoleum — The Serpentine Drive to Njegoš's Tomb at 1,657 m", description: "A driving guide from Budva to the Njegoš Mausoleum on Mount Lovćen: the road, the ascent, the 461-step climb to the tomb, and the view from the summit at 1,657 metres.", type: 'website' },
  };
}

export default function BudvaToLovcenMausoleumRoute() {
  const articleSchema = {
