...
export async function generateMetadata() {
  return {
    ...
    alternates: buildAlternates('blog/pastrovici-highlands-drive'),
    openGraph: { title: "The Paštrovići Highlands Drive — Inland from Budva", description: "A driver's guide to the Paštrovići highlands: Praskvica Monastery, Kosmač Fortress, the drive from Sveti Stefan, and hill-village food.", type: 'website' },
  };
}

export default function PastroviciHighlandsDriveRoute() {
  const articleSchema = {
