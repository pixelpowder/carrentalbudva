...
export async function generateMetadata() {
  return {
    ...
    alternates: buildAlternates('blog/mogren-beach-dukley-tunnel'),
    openGraph: { title: "Mogren Beach and the Cliff Tunnel — Two Hidden Coves Just North of Budva Old Town", description: "A guide to Mogren Beach I and II near Budva Old Town: the cliff-path approach, the short connecting tunnel, swimming conditions, and the Dukley headland above.", type: 'website' },
  };
}

export default function MogrenBeachDukleyTunnelRoute() {
  const articleSchema = {
