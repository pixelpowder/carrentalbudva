...
export async function POST(request) {
  try {
    ...
    const sitePrefix = process.env.SITE_PREFIX || 'BUD';
    const fromName = process.env.MAIL_FROM_NAME || 'Car Rental Budva';
    const fromAddress = process.env.MAIL_FROM || 'noreply@carrentalbudva.com';
